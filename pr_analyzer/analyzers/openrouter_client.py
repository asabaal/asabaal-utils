...
class OpenRouterClient:
    ...
    def __init__(self, api_key: Optional[str] = None, model: Optional[str] = None):
        ...
        Args:
            ...
            model: Model to use (default: qwen/qwen-2.5-coder-32b-instruct)
        """
        if openai is None:
            raise ImportError(
        ...
        # Use environment variable or default to Qwen2.5 Coder
        self.model = model or os.getenv('OPENROUTER_MODEL', 'qwen/qwen-2.5-coder-32b-instruct')
