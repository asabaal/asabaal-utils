...
"""
    ...
    def test_init_with_config(self, mock_config):
        ...
        with patch('asabaal_utils.agents.spec_coder.generator.SpecParser') as mock_parser_class, \
             patch('asabaal_utils.agents.spec_coder.generator.OllamaClient') as mock_ollama_class, \
             patch('asabaal_utils.agents.spec_coder.generator.PromptTemplates') as mock_templates_class:
