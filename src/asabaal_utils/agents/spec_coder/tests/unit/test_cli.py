...
try:
    from asabaal_utils.agents.spec_coder.cli import setup_logging, cmd_generate, cmd_test, cmd_heal, cmd_organize, cmd_stage1, cmd_stage2, cmd_stage3, cmd_stage4, cmd_full_run, main
except ImportError:
...
class TestCLI:
    ...
    def test_cmd_generate_success(self, temp_dir):
        ...
        with patch('asabaal_utils.agents.spec_coder.cli.CodeGenerator') as mock_generator_class:
            mock_generator = Mock()
            ...
            with patch('builtins.print') as mock_print:
                ...
                mock_print.assert_any_call("✅ Generation completed successfully!")
                mock_print.assert_any_call(f"📁 Generated {len(mock_result.files_generated)} files:")
    ...
    def test_cmd_test_success(self, temp_dir):
        ...
        with patch('asabaal_utils.agents.spec_coder.cli.TestAnalyzer') as mock_analyzer_class:
            mock_analyzer = Mock()
            ...
            with patch('builtins.print') as mock_print:
                ...
                mock_print.assert_any_call("✅ All tests passed!")
    ...
    def test_cmd_heal_success(self, temp_dir):
        ...
        with patch('asabaal_utils.agents.spec_coder.healer.Healer') as mock_healer_class:
            mock_healer = Mock()
            ...
            with patch('builtins.print') as mock_print:
                ...
                mock_print.assert_any_call("✅ Healing completed successfully!")
    ...
    def test_cmd_organize_success(self, temp_dir):
        ...
        with patch('asabaal_utils.agents.spec_coder.cli.CodeOrganizer') as mock_organizer_class:
            mock_organizer = Mock()
            ...
            with patch('builtins.print') as mock_print:
                ...
                mock_print.assert_any_call("✅ Code organization completed!")
    ...
    def test_cmd_stage1_success(self, temp_dir):
        ...
        with patch('asabaal_utils.agents.spec_coder.cli.IntegrationOrchestrator') as mock_orchestrator_class:
            ...
            with patch('builtins.print') as mock_print:
                ...
                mock_print.assert_any_call("✅ Stage 1 completed successfully!")
    ...
    def test_main_generate_command(self, temp_dir):
        ...
        with patch('sys.argv', ['cli'] + test_args):
            with patch('asabaal_utils.agents.spec_coder.cli.cmd_generate') as mock_cmd:
    ...
    def test_main_test_command(self, temp_dir):
        ...
        with patch('sys.argv', ['cli'] + test_args):
            with patch('asabaal_utils.agents.spec_coder.cli.cmd_test') as mock_cmd:
                mock_cmd.return_value = 0
    ...
    def test_main_heal_command(self, temp_dir):
        ...
        with patch('sys.argv', ['cli'] + test_args):
            with patch('asabaal_utils.agents.spec_coder.cli.cmd_heal') as mock_cmd:
                mock_cmd.return_value = 0
    ...
    def test_main_organize_command(self, temp_dir):
        ...
        with patch('sys.argv', ['cli'] + test_args):
            with patch('asabaal_utils.agents.spec_coder.cli.cmd_organize') as mock_cmd:
                mock_cmd.return_value = 0
    ...
    def test_main_orchestrate_command(self, temp_dir):
        ...
        with patch('sys.argv', ['cli'] + test_args):
            with patch('asabaal_utils.agents.spec_coder.cli.cmd_full_run') as mock_cmd:
                mock_cmd.return_value = 0
    ...
    def test_cmd_stage2_success(self, temp_dir):
        """Test cmd_stage2 successful execution."""
        args = Mock()
        args.verbose = False
        args.output = temp_dir / "output"
        ...
        with patch('asabaal_utils.agents.spec_coder.cli.IntegrationOrchestrator') as mock_orchestrator_class:
            ...
            with patch('builtins.print') as mock_print:
                result = cmd_stage2(args)
                
                assert result == 0
                mock_orchestrator._stage2_scaffold_to_requirements.assert_called_once_with(args.output)
                mock_print.assert_any_call("✅ Stage 2 completed successfully!")
    
    def test_cmd_stage2_failure(self, temp_dir):
        """Test cmd_stage2 when stage fails."""
        args = Mock()
        args.verbose = False
        args.output = temp_dir / "output"
        ...
        with patch('asabaal_utils.agents.spec_coder.cli.IntegrationOrchestrator') as mock_orchestrator_class:
            mock_orchestrator = Mock()
            mock_orchestrator_class.return_value = mock_orchestrator
            mock_orchestrator._stage2_scaffold_to_requirements.return_value = False
            
            result = cmd_stage2(args)
            
            assert result == 1
    
    def test_cmd_stage3_success(self, temp_dir):
        """Test cmd_stage3 successful execution."""
        args = Mock()
        args.verbose = False
        args.output = temp_dir / "output"
        ...
        with patch('asabaal_utils.agents.spec_coder.cli.IntegrationOrchestrator') as mock_orchestrator_class:
            ...
            with patch('builtins.print') as mock_print:
                result = cmd_stage3(args)
                
                assert result == 0
                mock_orchestrator._stage3_requirements_to_alignment.assert_called_once_with(args.output)
                mock_print.assert_any_call("✅ Stage 3 completed successfully!")
    
    def test_cmd_stage3_failure(self, temp_dir):
        """Test cmd_stage3 when stage fails."""
        args = Mock()
        args.verbose = False
        args.output = temp_dir / "output"
        ...
        with patch('asabaal_utils.agents.spec_coder.cli.IntegrationOrchestrator') as mock_orchestrator_class:
            mock_orchestrator = Mock()
            mock_orchestrator_class.return_value = mock_orchestrator
            mock_orchestrator._stage3_requirements_to_alignment.return_value = False
            
            result = cmd_stage3(args)
            
            assert result == 1
    
    def test_cmd_stage4_success(self, temp_dir):
        """Test cmd_stage4 successful execution."""
        args = Mock()
        args.verbose = False
        args.output = temp_dir / "output"
        args.dry_run = False
        ...
        with patch('asabaal_utils.agents.spec_coder.cli.IntegrationOrchestrator') as mock_orchestrator_class:
            ...
            with patch('builtins.print') as mock_print:
                result = cmd_stage4(args)
                
                assert result == 0
                mock_orchestrator._stage4_alignment_to_code.assert_called_once_with(args.output, dry_run=False)
                mock_print.assert_any_call("✅ Stage 4 completed successfully!")
    
    def test_cmd_stage4_dry_run(self, temp_dir):
        """Test cmd_stage4 with dry run enabled."""
        args = Mock()
        args.verbose = False
        args.output = temp_dir / "output"
        args.dry_run = True
        ...
        with patch('asabaal_utils.agents.spec_coder.cli.IntegrationOrchestrator') as mock_orchestrator_class:
            ...
            with patch('builtins.print') as mock_print:
                ...
                assert result == 0
                mock_orchestrator._stage4_alignment_to_code.assert_called_once_with(args.output, dry_run=True)
                mock_print.assert_any_call("✅ Stage 4 completed successfully!")
    
    def test_cmd_stage4_failure(self, temp_dir):
        """Test cmd_stage4 when stage fails."""
        args = Mock()
        args.verbose = False
        args.output = temp_dir / "output"
        args.dry_run = False
        ...
        with patch('asabaal_utils.agents.spec_coder.cli.IntegrationOrchestrator') as mock_orchestrator_class:
            mock_orchestrator = Mock()
            mock_orchestrator_class.return_value = mock_orchestrator
            mock_orchestrator._stage4_alignment_to_code.return_value = False
            
            result = cmd_stage4(args)
            
            assert result == 1
    
    def test_cmd_full_run_success(self, temp_dir):
        """Test cmd_full_run successful execution."""
        spec_file = temp_dir / "spec.md"
        spec_file.write_text("# Test Spec")
        ...
        with patch('asabaal_utils.agents.spec_coder.cli.IntegrationOrchestrator') as mock_orchestrator_class:
            ...
            with patch('builtins.print') as mock_print:
                ...
                assert result == 0
                mock_orchestrator.run_full_pipeline.assert_called_once_with(spec_file, args.output)
                mock_print.assert_any_call("✅ Full pipeline completed successfully!")
    
    def test_cmd_full_run_failure(self, temp_dir):
        """Test cmd_full_run when pipeline fails."""
        spec_file = temp_dir / "spec.md"
        spec_file.write_text("# Test Spec")
        ...
        with patch('asabaal_utils.agents.spec_coder.cli.IntegrationOrchestrator') as mock_orchestrator_class:
            mock_orchestrator = Mock()
            mock_orchestrator_class.return_value = mock_orchestrator
            mock_orchestrator.run_full_pipeline.return_value = False
            
            result = cmd_full_run(args)
            
            assert result == 1
    
    def test_main_stage2_command(self, temp_dir):
        """Test main function with stage2 command."""
        test_args = ['stage2']
        
        with patch('sys.argv', ['cli'] + test_args):
            with patch('asabaal_utils.agents.spec_coder.cli.cmd_stage2') as mock_cmd:
                mock_cmd.return_value = 0
    ...
    def test_main_stage3_command(self, temp_dir):
        """Test main function with stage3 command."""
        test_args = ['stage3']
        
        with patch('sys.argv', ['cli'] + test_args):
            with patch('asabaal_utils.agents.spec_coder.cli.cmd_stage3') as mock_cmd:
                mock_cmd.return_value = 0
    ...
    def test_main_stage4_command(self, temp_dir):
        """Test main function with stage4 command."""
        test_args = ['stage4']
        
        with patch('sys.argv', ['cli'] + test_args):
            with patch('asabaal_utils.agents.spec_coder.cli.cmd_stage4') as mock_cmd:
                mock_cmd.return_value = 0
    ...
    def test_main_exception_handling(self):
        ...
        with patch('sys.argv', ['cli'] + test_args):
            with patch('asabaal_utils.agents.spec_coder.cli.cmd_generate', side_effect=Exception("Unexpected error")):
                with patch('builtins.print') as mock_print:
                    result = main()
