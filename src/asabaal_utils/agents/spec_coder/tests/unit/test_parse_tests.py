...
from asabaal_utils.agents.spec_coder.parse_tests import ParsedTestInfo, ASTVisitor, parse_test_file


class TestParsedTestInfo:
    """Test cases for ParsedTestInfo dataclass."""
    
    def test_creation(self):
        """Test creating ParsedTestInfo instance."""
        test_info = ParsedTestInfo(
            name="test_function",
...
class TestASTVisitor:
    """Test cases for ASTVisitor class."""
    
    def test_init(self):
        """Test ASTVisitor initialization."""
        visitor = ASTVisitor()
...
class TestParseTestMain:
    ...
    def test_main_function_exists(self):
        ...
        from asabaal_utils.agents.spec_coder.parse_tests import main
