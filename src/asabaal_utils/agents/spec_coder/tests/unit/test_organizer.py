...
class TestCodeOrganizer:
    ...
    def test_init_default_directory(self):
        ...
        # CodeOrganizer uses its own module's directory as default
        import asabaal_utils.agents.spec_coder.organizer as organizer_module
        expected_base = Path(organizer_module.__file__).resolve().parent
