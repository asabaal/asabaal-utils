...
sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent.parent / "src" / "asabaal_utils" / "shared"))
from asabaal_utils.shared.agentic_toolkit import create_detailed_analysis_processor, BatchProcessingConfig
