...
from stages.stage7_detailed_analysis import DetailedAnalysisEngine as DetailedAnalysisEngineV1
...
# Try to import V2 toolkit version
TOOLKIT_VERSION_AVAILABLE = False
try:
    from stages.stage7_detailed_analysis_v2 import DetailedAnalysisEngine as DetailedAnalysisEngineV2
    TOOLKIT_VERSION_AVAILABLE = True
except ImportError:
    DetailedAnalysisEngineV2 = None
    TOOLKIT_VERSION_AVAILABLE = False
...
class UnifiedPRAnalyzer:
    ...
    def run_stage1_context_prep(self, from_branch: str, to_branch: str) -> bool:
        ...
        try:
            stage1 = ContextPreparationTester(str(self.repo_path), str(self.output_dir))
    ...
    def run_stage2_agent_prompts(self) -> bool:
        ...
        try:
            stage2 = AgentPromptTester(str(self.output_dir))
    ...
    def run_stage5_issue_extraction(self) -> bool:
        ...
        try:
            stage5 = IssueValidator(str(self.output_dir))
    ...
    def run_stage6_filtering_combination(self) -> bool:
        ...
        try:
            stage6 = ResultCombiner(str(self.output_dir))
    ...
    def run_stage7_detailed_analysis(self) -> bool:
        ...
        try:
            ...
            if TOOLKIT_VERSION_AVAILABLE and DetailedAnalysisEngineV2 is not None:
                if self.debug_mode:
    ...
    def run_stage10_feedback_update(self, feedback: Optional[str] = None, feedback_files: Optional[list] = None) -> bool:
        ...
        try:
            ...
            if success:
                ...
                source_debug = repo_root / "agents" / "pr_analyzer" / "debug_outputs" / "stage10_feedback"
